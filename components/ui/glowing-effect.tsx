            ...
            <>
                ...
                <div
                  ...
                  var(--black) calc(25% / var(--repeating-conic-gradient-times))
                                    ...
                                    : variant === "orange"
                                        ? `radial-gradient(circle, #f48c21 10%, #f48c2100 20%),
                ...
                repeating-conic-gradient(
                  ...
                  #dd7bbb calc(100% / var(--repeating-conic-gradient-times))
                    ...
                    className={cn(
                        "pointer-events-none absolute -inset-px rounded-[inherit] opacity-100 transition-opacity z-20",
                        glow && "opacity-100",
